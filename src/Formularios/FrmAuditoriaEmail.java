...
public class FrmAuditoriaEmail extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaEmail() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE CORREOS ELECTRÓNICOS");
    ...
    modelo.addColumn("NUEVO EMAIL");
    modelo.addColumn("ANTERIOR ID MEDIO");
    modelo.addColumn("ANTERIOR EMAIL");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_email";
