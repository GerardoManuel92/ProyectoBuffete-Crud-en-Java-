...
public class FrmRegistroPersonasDemandadas extends javax.swing.JInternalFrame {
    
    ConectarBD conectar = new ConectarBD();
    Connection cn = conectar.conexion();

    public FrmRegistroPersonasDemandadas() {
        initComponents();
        MostrarPersonas("");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PERSONAS DEMANDADAS REGISTRADOS EN SISTEMA");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/imagen18.jpg"))); // NOI18N
        ...
        jLabel2.setText("INGRESE CUALQUIER VALOR QUE DESEA BUSCAR DE UNA PERSONA");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_dato, javax.swing.GroupLayout.PREFERRED_SIZE, 426, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        txtpaterno.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));
        ...
        txtnombre.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));

        txtmaterno.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtmaterno.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));
    ...
    private void Limpiar(){
     ...
     private void MostrarTotalPersonas() {
        String sql = "SELECT COUNT(*) AS TOTAL FROM persona_demandada";
        try {            
    ...
    private void MostrarPersonas(String dato) {
        ...
        String sql = "";
        if (dato.equals("")) {
            sql = "SELECT * FROM persona_demandada ORDER BY id_demandado ASC";
        } else {
            sql = "SELECT * FROM persona_demandada WHERE id_demandado LIKE '%" + dato + "%' OR paterno LIKE'%" + dato + "%'OR materno LIKE'%" + dato + "%'OR nombre LIKE'%" + dato + "%'";
        }
    ...
    private void ModificarPersona(int id, String paterno, String materno, String nombre) {       
        PreparedStatement pst = null;
        try {
            pst = cn.prepareStatement("UPDATE persona_demandada SET paterno='" + paterno
                    + "',materno='" + materno + "',nombre='"+nombre+ "' WHERE id_demandado='" + id + "'");
    ...
    private void EliminarPersona() {        
        ...
        try {
            pst = cn.prepareStatement("DELETE FROM persona_demandada WHERE id_demandado='" + id + "'");
            ...
            if (s == 0) {                
                ...
                MostrarTotalPersonas();
                MostrarPersonas("");
                JOptionPane.showMessageDialog(null, "LA PERSONA HA SIDO ELIMINADO");
                Limpiar();
            }
