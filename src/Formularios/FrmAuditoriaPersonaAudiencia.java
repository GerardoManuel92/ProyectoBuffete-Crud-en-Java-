...
public class FrmAuditoriaPersonaAudiencia extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaPersonaAudiencia() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE PERSONAS INVOLUCRADAS EN AUDIENCIAS");
    ...
    private void MostrarRegistros() {
        ...
        Statement st;
        ResultSet rs;
        String sql = "SELECT * FROM auditoria_persona_audiencia";
