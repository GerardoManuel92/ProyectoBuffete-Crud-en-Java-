...
public class FrmAuditoriaGradosAcademicos extends javax.swing.JInternalFrame {
    ConectarBD condb=new ConectarBD();
    Connection cn=condb.conexion();

    public FrmAuditoriaGradosAcademicos() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE GRADOS ACADÉMICOS");
    ...
    modelo.addColumn("NUEVO ID GRADO");
    modelo.addColumn("NUEVO GRADO");
    modelo.addColumn("ANTERIOR ID GRADO");
    modelo.addColumn("ANTERIOR GRADO");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_grado_academico";
