...
public class FrmAuditoriaTipoDemandado extends javax.swing.JInternalFrame {
    
    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    /** Creates new form FrmAuditoriaTipoDemandado */
    public FrmAuditoriaTipoDemandado() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE TIPOS DE MEDIOS");
    ...
    modelo.addColumn("NUEVA DESCRIPCION");
    modelo.addColumn("ANTERIOR ID TIPO");
    modelo.addColumn("ANTERIOR DESCRIPCION");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_tipo_demandado";
