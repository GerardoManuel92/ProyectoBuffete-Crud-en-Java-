...
public class FrmAuditoriaAsuntos extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaAsuntos() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE ASUNTOS");
    ...
    private void MostrarRegistros() {
        ...
        modelo.addColumn("NUEVO ID ASUNTO");
        modelo.addColumn("NUEVO ID CLIENTE");
        modelo.addColumn("NUEVO ID DEMANDADO");
        modelo.addColumn("NUEVO ID ESTADO");
        modelo.addColumn("NUEVO ID ABOGADO");
        modelo.addColumn("NUEVO ID TIPO");
        modelo.addColumn("NUEVA FECHA_INICIO");
        modelo.addColumn("NUEVA FECHA_TERMINO");
        modelo.addColumn("ANTERIOR ID ASUNTO");
        modelo.addColumn("ANTERIOR ID CLIENTE");
        modelo.addColumn("ANTERIOR ID DEMANDADO");
        modelo.addColumn("ANTERIOR ID ESTADO");
        modelo.addColumn("ANTERIOR ID ABOGADO");
        modelo.addColumn("ANTERIOR ID TIPO");
        modelo.addColumn("ANTERIOR FECHA_INICIO");
        modelo.addColumn("ANTERIOR FECHA_TERMINO");
        tabla_registros.setModel(modelo);

        Statement st;
        ResultSet rs;
        String datos[] = new String[19];
        String sql = "SELECT * FROM auditoria_asunto";
        try {
