...
public class FrmAuditoriaTiposMedios extends javax.swing.JInternalFrame {
    
    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaTiposMedios() {
        initComponents();
        MostrarRegistros();
    }
 ...
 private void MostrarRegistros(){
    ...
    modelo.addColumn("NUEVO MEDIO");
    modelo.addColumn("ANTERIOR ID TIPO");
    modelo.addColumn("ANTERIOR MEDIO");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_tipo_medio";
