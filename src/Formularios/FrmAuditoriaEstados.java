...
public class FrmAuditoriaEstados extends javax.swing.JInternalFrame {
    ConectarBD condb=new ConectarBD();
    Connection cn=condb.conexion();

    public FrmAuditoriaEstados() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE ESTADOS");
    ...
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_estado";
