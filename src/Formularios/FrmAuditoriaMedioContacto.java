...
public class FrmAuditoriaMedioContacto extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaMedioContacto() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE MEDIOS DE CONTACTO");
    ...
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_medio_contacto";
