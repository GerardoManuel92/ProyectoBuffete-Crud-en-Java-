...
public class FrmAuditoriaAsuntoAbogado extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaAsuntoAbogado() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS ASIGNACIONES DE ASUNTOS A ABOGADOS");
    ...
    private void MostrarRegistros() {
        ...
        modelo.addColumn("NUEVO ABOGADO");
        modelo.addColumn("NUEVO ASUNTO");
        modelo.addColumn("ANTERIOR ABOGADO");
        modelo.addColumn("ANTERIOR ASUNTO");
        tabla_registros.setModel(modelo);

        Statement st;
        ResultSet rs;
        String sql = "SELECT * FROM auditoria_asunto_abogado";
