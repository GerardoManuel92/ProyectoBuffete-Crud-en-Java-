...
public class FrmAuditoriaAsistenciaPersonas extends javax.swing.JInternalFrame {
ConectarBD condb=new ConectarBD();
Connection cn=condb.conexion();
    public FrmAuditoriaAsistenciaPersonas() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS PERSONAS EN AUDIENCIAS");
    ...
    modelo.addColumn("NUEVO ID PERSONA");
    modelo.addColumn("NUEVO ID AUDIENCIA");
    modelo.addColumn("ANTERIOR ID PERSONA");
    modelo.addColumn("ANTERIOR ID AUDIENCIA");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_asistencia_personas";
