...
public class FrmAuditoriaAsesoria extends javax.swing.JInternalFrame {

    ConectarBD condb = new ConectarBD();
    Connection cn = condb.conexion();

    public FrmAuditoriaAsesoria() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE ASESORIAS");
    ...
    private void MostrarRegistros() {
        ...
        modelo.addColumn("NUEVO ASESOR");
        modelo.addColumn("NUEVO ASESORADO");
        modelo.addColumn("NUEVO ASUNTO");
        modelo.addColumn("NUEVO TEMA");
        modelo.addColumn("NUEVA HORA");
        modelo.addColumn("NUEVA FECHA");
        modelo.addColumn("ANTERIOR ASESOR");
        modelo.addColumn("ANTERIOR ASESORADO");
        modelo.addColumn("ANTERIOR ASUNTO");
        modelo.addColumn("ANTERIOR TEMA");
        ...
        Statement st;
        ResultSet rs;
        String sql = "SELECT * FROM auditoria_asesoria";
