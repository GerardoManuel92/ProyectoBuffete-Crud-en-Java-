...
public class FrmAuditoriaAbogados extends javax.swing.JInternalFrame {
ConectarBD condb=new ConectarBD();
Connection cn=condb.conexion();
    
    public FrmAuditoriaAbogados() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE ABOGADOS");
    ...
    private void MostrarRegistros() {
        ...
        modelo.addColumn("NUEVA CEDULA");
        modelo.addColumn("NUEVO GRADO");
        ...
        modelo.addColumn("ANTERIOR CEDULA");
        modelo.addColumn("ANTERIOR GRADO");
        tabla_registros.setModel(modelo);

        Statement st;
        ResultSet rs;
        String sql = "SELECT * FROM auditoria_abogado";
