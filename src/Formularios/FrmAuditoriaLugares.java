...
public class FrmAuditoriaLugares extends javax.swing.JInternalFrame {

     ConectarBD condb=new ConectarBD();
    Connection cn=condb.conexion();
    
    public FrmAuditoriaLugares() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE OFICINAS O JUZGADOS CÍVICOS");
    ...
    modelo.addColumn("NUEVO ID LUGAR");
    modelo.addColumn("NUEVO LUGAR");
    modelo.addColumn("ANTERIOR ID LUGAR");
    modelo.addColumn("ANTERIOR OFICINA");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_lugar";
