...
public class FrmAuditoriaResoluciones extends javax.swing.JInternalFrame {

    ConectarBD condb=new ConectarBD();
    Connection cn=condb.conexion();
    
    public FrmAuditoriaResoluciones() {
        initComponents();
        MostrarRegistros();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUDITORIA DE REGISTROS DE RESOLUCIONES");
    ...
    modelo.addColumn("NUEVO ID RESOLUCION");
    modelo.addColumn("NUEVA RESOLUCION");
    modelo.addColumn("ANTERIOR ID RESOLUCION");
    modelo.addColumn("ANTERIOR RESOLUCION");
    tabla_registros.setModel(modelo);
    
    Statement st;
    ResultSet rs;
    String sql="SELECT * FROM auditoria_resolucion";
